...
function Archivo_Tipo_FT001()
{
	...
	curl_setopt_array($curl, array(
		CURLOPT_URL => 'https://goanywhere.cajacopieps.com/rest/forms/v1/SP_Oracle_FT001/payload/' . $tokens . '/submit',
		CURLOPT_RETURNTRANSFER => true,
		CURLOPT_ENCODING => '',
		CURLOPT_MAXREDIRS => 10,
		CURLOPT_TIMEOUT => 30,
...
function Archivo_Tipo_FT003()
{
	...
	curl_setopt_array($curl, array(
		CURLOPT_URL => 'https://goanywhere.cajacopieps.com/rest/forms/v1/SP_Oracle_FT003/payload/' . $tokens . '/submit',
		CURLOPT_RETURNTRANSFER => true,
		CURLOPT_ENCODING => '',
		CURLOPT_MAXREDIRS => 10,
		CURLOPT_TIMEOUT => 30,
...
function Archivo_Tipo_FT004()
{
	...
	curl_setopt_array($curl, array(
		CURLOPT_URL => 'https://goanywhere.cajacopieps.com/rest/forms/v1/SP_Oracle_FT004/payload/' . $tokens . '/submit',
		CURLOPT_RETURNTRANSFER => true,
		CURLOPT_ENCODING => '',
		CURLOPT_MAXREDIRS => 10,
		CURLOPT_TIMEOUT => 30,
...
function Archivo_Tipo_FT005()
{
	...
	curl_setopt_array($curl, array(
		CURLOPT_URL => 'https://goanywhere.cajacopieps.com/rest/forms/v1/SP_Oracle_FT005/payload/' . $tokens . '/submit',
		CURLOPT_RETURNTRANSFER => true,
		CURLOPT_ENCODING => '',
		CURLOPT_MAXREDIRS => 10,
		CURLOPT_TIMEOUT => 30,
...
function Archivo_Tipo_FT0011()
{
	...
	curl_setopt_array($curl, array(
		CURLOPT_URL => 'https://goanywhere.cajacopieps.com/rest/forms/v1/SP_Oracle_FT011/payload/' . $tokens . '/submit',
		CURLOPT_RETURNTRANSFER => true,
		CURLOPT_ENCODING => '',
		CURLOPT_MAXREDIRS => 10,
		CURLOPT_TIMEOUT => 30,
...
function ReportedeInformesparaComitedePagos()
{
	...
	curl_setopt_array($curl, array(
		CURLOPT_URL => 'https://goanywhere.cajacopieps.com/rest/forms/v1/SP_Oracle_Re_Comite_pagos/payload/' . $tokens . '/submit',
		CURLOPT_RETURNTRANSFER => true,
		CURLOPT_ENCODING => '',
		CURLOPT_MAXREDIRS => 10,
		CURLOPT_TIMEOUT => 30,
...
function Reporte_circular017()
{
	...
	$curl = curl_init();
	curl_setopt_array($curl, array(
		CURLOPT_URL => 'https://goanywhere.cajacopieps.com/rest/forms/v1/SP_Oracle_Re_pagos_cir017/payload/' . $tokens . '/submit',
		CURLOPT_RETURNTRANSFER => true,
		CURLOPT_ENCODING => '',
		CURLOPT_MAXREDIRS => 10,
		CURLOPT_TIMEOUT => 30,
