...
function insertaroreq()
{
	...
	$consulta = oci_parse($c, 'BEGIN PQ_GENESIS_INVENTARIO_ADM.P_INSERTA_OREQ(:v_pconcepto,:v_pestado,:v_pobservaciondes,
								:v_psolicitante,:v_pubicacion,:v_pcargarbodega,:v_cantidadproduc,:v_productos,:v_json_row); end;');
	...
	oci_bind_by_name($consulta, ':v_pcargarbodega', $request->CARGARBODEGA);	
...
function actualizaroreq()
{
	...
	$consulta = oci_parse($c, 'BEGIN PQ_GENESIS_INVENTARIO_ADM.P_ACTUALIZA_OREQ(:v_pnumero,:v_pconcepto,:v_pestado,:v_pobservaciondes,
							:v_pubicacion,:v_pcargarbodega,:v_cantidadproduc,:v_productos,:v_json_row); end;');
...
function Obtener_Inf_Entrega()
{
	...
	global $request;
	$NUMERO = $request->acas;
	$consulta = oci_parse($c, 'BEGIN PQ_GENESIS_INVENTARIO_ADM.P_IMPRIMIR_ENTREGA(:v_acas,:v_json_row); end;');
...
function cargarbodegaoreq()
{
	require_once('../config/dbcon_prod.php');
	global $request;
	$consulta = oci_parse($c, 'BEGIN PQ_GENESIS_INVENTARIO_ADM.P_CARGAR_BODEGA_OREQ(:v_numero,:v_cedula,:v_json_row); end;');
...
function BuscarEntrega()
{
	require_once('../config/dbcon_prod.php');
	global $request;
	$consulta = oci_parse($c, 'BEGIN PQ_GENESIS_INVENTARIO_ADM.P_BUSCAR_ENTREGA(:v_acas,:v_ubi,:v_cedula,:v_json_row); end;');
	oci_bind_by_name($consulta, ':v_acas', $request->acas);
	oci_bind_by_name($consulta, ':v_ubi', $request->ubi);
	oci_bind_by_name($consulta, ':v_cedula', $request->cedula);
	$clob = oci_new_descriptor($c, OCI_D_LOB);
	oci_bind_by_name($consulta, ':v_json_row', $clob, -1, OCI_B_CLOB);
	oci_execute($consulta, OCI_DEFAULT);
...
function ActualizarEntrega()
{
	require_once('../config/dbcon_prod.php');
	global $request;
	$consulta = oci_parse($c, 'BEGIN PQ_GENESIS_INVENTARIO_ADM.P_ACTUALIZAR_ENTREGA(:v_acas,:v_ubicacion,:v_bodega,:v_cedula,:v_cantidadprod,:v_productos,:v_json_row); end;');
	oci_bind_by_name($consulta, ':v_acas', $request->acas);
	oci_bind_by_name($consulta, ':v_ubicacion', $request->cod_acas);
	oci_bind_by_name($consulta, ':v_bodega', $request->bodega);
	oci_bind_by_name($consulta, ':v_cedula', $request->cedula);
	oci_bind_by_name($consulta, ':v_cantidadprod', $request->cantidad);
	oci_bind_by_name($consulta, ':v_productos', $request->PRODUCTOS);
	$clob = oci_new_descriptor($c, OCI_D_LOB);
	oci_bind_by_name($consulta, ':v_json_row', $clob, -1, OCI_B_CLOB);
	oci_execute($consulta, OCI_DEFAULT);
	if (isset($clob)) {
...
function Obtener_Inf_Inventario_Actual()
{
	require_once('../config/dbcon_prod.php');
	global $request;
	$consulta = oci_parse($c, 'BEGIN PQ_GENESIS_INVENTARIO_ADM.P_IMPRIMIR_INVENTARIO_ACTUAL(:v_seccional,:v_concepto,:v_json_row); end;');
	oci_bind_by_name($consulta, ':v_seccional', $request->seccional);
	oci_bind_by_name($consulta, ':v_concepto', $request->concepto);
	$clob = oci_new_descriptor($c, OCI_D_LOB);
	oci_bind_by_name($consulta, ':v_json_row', $clob, -1, OCI_B_CLOB);
	oci_execute($consulta, OCI_DEFAULT);
	if (isset($clob)) {
