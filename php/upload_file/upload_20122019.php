<?php
	...
	function GTUT01 ($ruta){
		...
		$consulta = oci_parse($c,'begin pq_genesis_tut.p_ins_tutela_archivo(:v_pnumero,:v_pubicacion,:v_ptipo,:v_pfecha_recibido,:v_parchivo,:v_presponsable,:v_pfallo_impugnacion,:v_json_row); end;');
