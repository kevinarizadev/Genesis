...
//Aqui va la consulta y/o procedimiento a ser ejecutado en la base de datos. Los parametros van con :nombreparametro
 $consulta = oci_parse($c," SELECT a.num_autorizacion, a.seccional,a.tipo_documento,
                            a.documento, a.nombre_afiliado,
                            a.fecha_nacimiento, a.edad, a.sexo, 
                            a.autn_autorizacion_manual,
                            a.fecha_orden, 
                            trunc(a.fecha_solicitud) fecha_solicitud,
                            trunc(a.fecha_procesado) fecha_procesado,
                            a.autf_pss fecha_prestacion,
                            a.dias_habiles_orden_vs_solicitud dias_orden_sol,
                            a.dias_habiles_solicitud_vs_autorizacion dias_sol_aut, 
                            a.nit_pss, a.razon_social, a.nit_solicitante, a.ubicacion_ter, a.razon_solial_ips_solicitante,  a.codigo_municipio, a.codigo_dpto_afiliado,
                            ...
                            a.valor_servicio, a.copago, a.doc_responsable_aut, a.nombre_responsable, a.estado, 
                            ...
                            //AND ROWNUM <= 1000");
                            //   WHERE a.año = 2020
                            //   AND to_number(a.mes) = 11
                            //   AND to_number(a.codigo_dpto_afiliado) = 44
                            //   AND ROWNUM <= 100");
...
while( $rows = oci_fetch_assoc($consulta))
{
	        echo "<tr>";
                      ...
                      //echo "<td>"; echo$rows['FECHA_PRESTACION']; echo "</td>";
                      echo "<td>"; echo$rows['DIAS_ORDEN_SOL']; echo "</td>";
                      echo "<td>"; echo$rows['DIAS_SOL_AUT']; echo "</td>";
