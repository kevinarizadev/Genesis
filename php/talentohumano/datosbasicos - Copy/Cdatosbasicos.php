<?php
  ...
  function logicaestudio(){
	...
	function registrardatos(){
		...
		$teletrabajo = 'N';
		$consulta = oci_parse($c,'BEGIN PQ_GENESIS_TH.P_LOGICA_DATOS_BASICOS(:v_pcedula,:v_ptipo,:v_ppapellido,:v_psapellido,:v_ppnombre,:v_psnombre,:v_pnacimiento,:v_psexo,:v_prh,:v_pestado_civil,
																																				 :v_ppeso,:v_pestatura,:v_ptelefono,:v_pcelular,:v_pmun,:v_prethus,:v_pbarrio,:v_pdireccion,:v_pemail_personal,:v_pmune,:v_ptipo_contrato,
																																				 :v_pempleador,:v_punidad_estrategica,:v_punidad_funcional,:v_pcargo,:v_premuneracion,:v_psalario,:v_pgrupo_salarial,:v_pfecha_ingreso,
																																				 :v_pterf_egreso,:v_ptipo_cuenta,:v_pnumero_cuenta,:v_pbanco,:v_pestado_empleado,:v_ptipo_dato,:v_pteletrabajo,:v_prespuesta); end;');
