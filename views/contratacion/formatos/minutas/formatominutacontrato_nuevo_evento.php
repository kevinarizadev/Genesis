        ...
        <td>
          ...
          <div id="minuta_contrato">
            ...
            <div class="minuta_texto">Los afiliados a la ERP activos en la base de datos serán objeto del presente
              acuerdo de voluntades, la cual podrá ser accedidoa por el PSS, acorde al proceso definido por la ERP.
            </div>
            ...
            <div class="minuta_texto">El PSS reportará a la ERP dentro de los primero cinco (5) días HÁBILES de cada mes
              vencido: 1. Los Indicadores de calidad de la atención de salud establecidos en el Anexo 9, a través de los
              mecanismos que la ERP establezca; especialmente el reporte de la resolución 1552 de 2013 deben hacerlo a
              través de la plataforma Genesis en el módulo salud/1552. 2. El reporte obligatorio de la Resolución 202 de
              2021. 3. Los Indicadores de reportes obligatorios en las normas vigentes de la Superintendencia Nacional
              de Salud 4. Los casos de sospecha de reacciones adversas a medicamentos deben ser notificados en el
            ...
            <div class="minuta_texto">El presente contrato podrá terminarse por: 1. Por mutuo acuerdo. 2. Por
              incumplimiento de las obligaciones del PSS contenidas o emanadas del presente contrato. 3. Por fuerza
              mayor o caso fortuito demostrado. 4. Cuando el término de suspensión supere los 4 meses, sin que se haya
              reanudado el contrato, 5. Por revocatoria de funcionamiento de una de las partes. 6. Por orden de
              autoridad pertinente y/o competente. 7. Cuando la ERP documente no conformidades graves en los procesos de
              atención y/o facturación de los servicios. 8. Cualquier sanción impuesta por parte de las Autoridades de
              Inspección, Vigilancia y Control al PSS y que tengan que ver con hechos o actos que afecten la calidad de
              los servicios contratados. 9. La ERP podrá terminar el contrato derivado de la no ejecución de los planes
              de mejoramiento solicitados en debida forma y por escrito al PSS sin que medie justa causa para dicha
              omisión. 10. Por cualquier situación donde alguna de las partes deje de hacer presencia en el municipio de
              prestación del servicio. 11. Cuando haya operado la condición resolutoria expresa. 12. Por resolución
              judicial debidamente ejecutoriada. 13. La ERP podrá terminar el contrato de manera unilateral si por causa
              de investigación administrativa, judicial o de vigilancia y control, el PSS resulte sancionado por acto
              que afecte el Código del buen Gobierno, la transparencia, la lealtad y confianza legítima de las partes.
              14. La ERP podrá terminar el contrato de manera unilateral, cuando el PSS subcontrate sin su autorización.
              15. Por las malas prácticas en las que pueda incurrir el PSS, por la inoportunidad en el servicio, falta
              de calidad, por cierre de las instalaciones donde presta servicio el PSS debido al paro, huelga promovida
              ...
              partes, con previo aviso de treinta (30) días calendario, sin que haya lugar a indemnización alguna. <span
              ...
              caso, cumpla con lo pactado, informándole las consecuencias de no atender el requerimiento. Si vencido el
              ...
              de terminación del presente contrato, para todos los efectos de este, se surtirán todos los alcances de la
              terminación del artículo 2.5.3.4.16 del Decreto 780 de 2016, sin detrimento de la resolución y/o
              conciliación de cuentas que eventualmente queden pendientes y que serán resueltas en los tiempos
            ...
            <div class="minuta_texto">Además de las causales de terminación previstas por la ley, el presente contrato
              se suspenderá en todos sus efectos, cuando quiera que ocurra una de las siguientes causas: 1) Cuando se
              adelante investigación administrativa, disciplinaria, civil o penal o adelantada por un ente de vigilancia
              y control por irregularidades cometidas por EL PSS y dependencias y dependientes, a discreción de la ERP y
              en consideración a la gravedad de los hechos motivo de la investigación. 2) Imposibilidad de carácter
              ...
              genera indemnización a favor de alguna de las partes.</div>
