        ...
        <td>
          <table id="table1" width="100%" style="border: #FFF;">
            ...
            <tr>
              <td colspan="5" class="text-center text-size8 text-right">
                <div style="display: inline-flex;width: 100%;">
                  <div style="width: 45%;">
                    <label for="clase_11">OTROS (UT)</label>
                    <input type="checkbox" id="clase_11" name="clase_11" onclick="return false;">
                  </div>
              ...
              <td colspan="5" class="text-center text-right">
                <div style="display: inline-flex;width: 100%;">
                  <div style="width: 45%;">
                    ...
                    <input type="checkbox" id="modalidad_3" name="modalidad_3" onclick="return false;">
                  </div>
                  <div style="width: 55%;">
                    <label for="modalidad_4">CONJUNTO INTEGRAL</label>
                    <input type="checkbox" id="modalidad_4" name="modalidad_4" onclick="return false;">
                  </div>
                </div>
              </td>
            </tr>
              ...
              <td colspan="5" class="text-center text-right">
                <div style="display: inline-flex;width: 100%;">
                  ...
                  <div style="width: 55%;">
                    ...
                    <input type="checkbox" id="modalidad_6" name="modalidad_6" ng-checked="false"
                      onclick="return false;">
                  </div>
                </div>
              </td>
          ...
          <div id="minuta_contrato">
            ...
            <div class="minuta_texto_1 mb">
              ...
              entidad identificada con NIT: {{DATA.NIT}}, , según consta en el certificado de existencia y
              representación legal adjunto, entidad debidamente habilitada para operar en el Sistema General de
              Seguridad Social en Salud, quien en adelante se denominará EL PSS/PTS; hemos decidido suscribir el
              presente CONTRATO DE PRESTACIÓN DE SERVICIOS DE SALUD EN LA MODALIDAD DE PAGO GLOBAL PROSPECTIVO, de común
              acuerdo para la atención de los afiliados, al Sistema General de Seguridad Social en Salud Régimen
              Subsidiado/Contributivo a través de CAJACOPI EPS S.A.S., el cual se regirá por el acuerdo contenido en las
              siguientes cláusulas y en lo no previsto por ellas, por la normatividad legal que resulte aplicable según
              la naturaleza de los servicios contratados, en especial la Ley 1122 de 2007, el Decreto 4747 de 2007, , la
              Ley 1438 de 2011, el Decreto 1683 de 2013, la Resolución 1841 de 2013, la Ley 1751 del 2015, el Decreto
              780 de 2016, la Resolución 429 del 2016, la Resolución 2515 del 2018, la Resolución 1885 del 2018 de la
              Administradora de los Recursos del Sistema de Seguridad Social en Salud -ADRES-, Resolución 205 de 2020,
              la Resolución 535 de 2020 del Ministerio de Salud y Protección Social, la Circular 013 de 2020 de la
              ADRES, Resolución 2350 de 2020 y el Decreto 441 de 2022, la Resolución 2811 de 2022, la Resolución 1403
              del 2007 y lo dispuesto en los articulos 4 y 5 de la resolución 2811 de 2022
               y por aquellas que las adicionen, modifiquen, aclaren o sustituyan, así como las que
              posteriormente se expidan y que sean aplicables a la naturaleza de las partes y de los servicios objeto
              del presente contrato a las cuales las partes se acogerán automáticamente, una vez entren en vigencia, las
              cuales se encuentran descritas en el Anexo 1 del presente acuerdo de voluntades.
            </div>
            <div class="minuta_titulo">CLAUSULADO</div>

            <div class="minuta_clausula">Cláusula 1. Objeto.</div>
            <div class="minuta_texto">
              El objeto del presente contrato o acuerdo de voluntades es el de prestar servicios de salud descritos en
              el Anexo 7 (Relación de sedes de atención y servicios de salud habilitados en REPS); para la Población que
              se encuentra descrita en la caratula, que se encuentra afiliada a la ERP y caracterizada en el Anexo 4
              (Caracterización de la población afiliada a Cajacopi EPS), según el Modelo de Atención de la ERP contenido
              en el Anexo 3, según el Modelo de Prestación de Servicios del PSS/PTS que se describe en el Anexo 6, y de
              acuerdo a la población objeto se describe en el Anexo 20. Los servicios se sujetan a los contenidos en el
              Plan de Beneficios financiado con la Unidad de Pago por Capitación y los financiados con los presupuestos
              máximos que defina el Ministerio de Salud y Protección Social. </div>
            <div class="minuta_texto"><span class="minuta_paragrafo">PARÁGRAFO. </span>
              Las tecnologías en salud serán prestados a los afiliados activos en la población afiliada objeto del
              contrato entregada los diez (10) primeros días de cada mes, descritos en el anexo 20, incluyendo los
              afiliad|os en portabilidad, considerando los grupos poblacionales vulnerables (personas con discapacidad,
              víctimas del conflicto armado y comunidades indígenas) para hacer efectivo el enfoque diferencial de
              territorio y poblacional, como estrategia para la ampliación gradual y continua del acceso a los servicios
              de poblaciones vulnerables a su cargo, acorde a las necesidades en salud, de conformidad con los datos
              sobre la ubicación geográfica y caracterización poblacional disponible en el Anexo 4.</div>



            <div class="minuta_clausula">Cláusula 2. Obligaciones del PSS/PTS.</div>
            <div class="minuta_texto">
              EL PSS/PTS se obliga con la ERP a: 1. Prestar los servicios objeto del presente contrato, a la población
              reportada en la caratula. 2. Permitir a la ERP o a quien este delegue el acceso a la información
              relacionada con el estado de salud del afiliado y la prestación de los servicios de salud, así mismo,
              permitirle el acceso a los documentos que requiera, de acuerdo con lo reglamentado en la Ley y en el
              presente contrato. 3. Suministrar información sobre la atención en salud prestada a los afiliados de la
              ...
              Anexos 14, 15 y 21 y en la Nota Técnica. 8. Recibir las glosas, responderlas, conciliarlas o en su defecto
              ...
              008 de la Superintendencia Nacional de Salud o aquella que la modifique, adicione o sustituya. 10. Atender
              los requerimientos derivados del cumplimiento de la supervisión del presente contrato. 11. Garantizar la
              calidad de los insumos, materiales y medicamentos utilizados en la atención de los usuarios y responder
              por los costos en que se incurra por reintervenciones y complicaciones donde se demuestre que la causa de
              estos sea debida a la mala calidad de los materiales, insumos o medicamentos utilizados durante la
              prestación de los servicios o a su rehúso sin cumplir con los estándares de rehúso del fabricante.
              Igualmente responderá en estos casos por la responsabilidad civil o penal que se deriven de estas
              complicaciones. 12. En el caso que un afiliado solicite los servicios incluidos en el presente contrato,
              EL PSS/PTS podrá brindar la atención solicitada siempre y cuando dicho afiliado se encuentre activo en
              verificación realizada a través del Portal Génesis / Opción Prestador (Consulta Afiliado) o en la página
              web de la ERP y/o en la base de datos de ADRES o que cuente con portabilidad en el (los) municipio (s)
              objeto del contrato. EL PSS/PTS reportará la atención y en los casos donde se encuentren inconsistencias
              en las bases de datos consultadas, estas deben ser reportadas de acuerdo con el marco normativo vigente
              descrito en el Anexo 1. Las atenciones prestadas serán facturadas mediante la modalidad de pago global
              prospectivo, y serán canceladas a las tarifas pactadas según la nota técnica vigente para dicho
              contrato.13. Cumplir los protocolos de atención de los programas de Gestión del Riesgo de la ERP y las
              guías de atención integral del Ministerio de Salud y Protección Social, previamente concertadas con la
              ERP, en el marco de las
              ...
              personas con discapacidad, embarazadas, personas de la tercera edad y demás que establezca la Ley. 15.
              Facilitar la información sobre notificación, clasificación, intervención y estudio de casos en los eventos
              de vigilancia epidemiológica. 16.Implementar el modelo servicios de salud amigables para adolescentes
              jóvenes y la estrategia Atención Integral de las Enfermedades Prevalentes de la Infancia - AIEPI acorde
              con lo definido en el marco normativo vigente descrito en el Anexo 1. 17. Entregar copia de los archivos
              en medio magnético en la misma estructura exigida en la Circular Única de la Superintendencia Nacional de
              Salud de los reportes de los indicadores mensuales y trimestrales de oportunidad y satisfacción de los
              usuarios. 18. Notificar los casos de los pacientes de grupos especiales: Renales, VIH, Cáncer,
              Tuberculosis, Hemofilia, Artritis, Enfermedades Huérfanas, Hipertensión Arterial y Diabetes Mellitus, con
              información y soportes clínicos concernientes a su atención y que es requerida para el reporte de la
              cuenta de Alto Costo ; para ello, la IPS deberá diligenciar el archivo de reporte de información de la
              cuenta de alto costo el cual debe ser entregado mensualmente dentro de los primeros cinco (5) días mes
              vencido, cargado en la herramienta SISCAC o en la que se determine para tal fin según la normatividad
              vigente. 19. Diseñar, implementar y notificar el modelo de gestión del servicio farmacéutico, según lo
              establecen las normas vigentes. 20. Implementar los diferentes comités reglamentados por la normatividad
              vigente, que le apliquen. 21. Implementar el Sistema de Información y Atención al Usuario para suministrar
              información, orientación y atención a los afiliados. 22. Derivar a los afiliados a los programas de
              mantenimiento de la salud e inducir su demanda de servicios de estos programas y dar especial énfasis a la
              atención de pacientes sospechosos de eventos de interés en salud pública. 23. Contar en el servicio de
              urgencias, si aplica según su habilitación, con el kit de atención a usuarios víctimas de violencia o
              agresión sexual, incluyendo especialmente anticoncepción de emergencia. 24. Informar a la ERP sobre
              cualquier novedad en los datos del afiliado, tales como teléfonos, correos electrónicos, dirección,
              ...
              garantizando la atención integral para cada caso, hasta que se certifique médicamente la recuperación de
              las victimas según en el marco normativo vigente descrito en el Anexo 1. 28. Cumplir con lo establecido en
              el numeral 1.4 de la circular 026 de 2020 del ministerio de salud y Protección Social, la cual establece
              que “se debe aplicar, según corresponda, las guías de práctica clínica, la Guía de Intervención mhGAP,
              para los trastornos mentales, neurológicos y por uso de sustancias en el nivel de atención de la salud no
              ...
              verificará mensualmente en el Registro Especial de Prestadores de Servicios de Salud, la vigencia de los
              servicios incluidos en el presente acuerdo de voluntades, y en caso de no encontrar algún servicio
              habilitado, este será inhabilitado del contrato sin previo aviso y no podrá ser facturado por el PSS/PTS.
              31. Gestionar oportunamente los Eventos adversos y alertas tempranas reportadas por parte de la ERP 32.
              ...
              dentro de la Política Integral de Atención en Salud -PAIS-. 38. Facilitar el proceso de
              ...
              necesidades en salud, a fin de que se garantice la continuidad en la prestación de los servicios. 39.
              ...
              contrato. 40. Realizar las fórmulas de medicamentos en la denominación común internacional tal como se
              ...
              incluidas en el mismo. 41.El PSS/PTS deberá diligenciar el cargue de actividades en el módulo dispuesto
              por la ERP diariamente con un plazo máximo de 24 horas posteriores a la prestación del servicio, y el
              último día calendario el mes a la hora 24:00 será el plazo máximo para el reporte de las atenciones del
              mes de ejecución, por lo que las atenciones no cargadas en el corte definido serán descontadas dentro del
              proceso de auditoría de contratos PGP. A su vez, deberá aportar los soportes correspondientes a cada
              actividad cargada para efectos de auditoría. 42. El PSS/PTS se obliga a las demás obligaciones derivadas
            ...
            <div class="minuta_texto">
              ...
              georreferenciadas y mediante los mecanismos de verificación de derechos al momento de la atención. De
              igual forma garantizar el acceso de la información requerida para el cumplimiento de las disposiciones que
              reglamentan la factura electrónica de venta en el sector salud, 2. Pagar las
              facturas debidamente radicadas, auditadas y conciliadas según los plazos establecidos en el marco
              normativo del Anexo 1. 3. Hacer seguimiento a la ejecución del presente contrato de conformidad con el
              manual de auditoría adjunto. 4. Publicar en la página web dentro de los primeros cinco días hábiles de
              cada mes,en la que aparecerán los afiliados actualizados, que incluye las novedades del mes anterior. 5.
              Entregar al PSS/PTS la caracterización de la población afiliada objeto del contrato 6. Garantizar la
              depuración, el correcto y oportuno registro de las novedades, así como la disponibilidad en línea de la
              población afiliada objeto del contrato desde la página web de la ERP o a través del Portal Génesis /
              Opción Prestador (Consulta Afiliado), para la verificación de derechos. 7. Entregar al PSS/PTS la red de
              servicios de salud contratada por la ERP para garantizar la oportunidad, integralidad, continuidad y
              accesibilidad en la prestación de servicios de los afiliados y publicar de manera permanente en la página
              web el listado actualizado de prestadores de servicios de salud que conforman dicha red. 8. Inscribir al
              PSS/PTS como parte de la red de prestadores de salud, una vez inicie el presente contrato, como prestador
              primario, complementario u oncológico, según sea el caso. 9. Verificar la permanencia de las condiciones
              de habilitación y de suficiencia (capacidad instalada) del PSS/PTS, 10. Concertar con El PSS/PTS los
              estándares de calidad de la atención en salud y realizar la evaluación a través de indicadores de calidad,
              de gestión y de resultados, según los mecanismos que establezca el Ministerio de la Protección Social y
              los indicadores de desempeño concertados entre las partes. 11. Realizar seguimiento a la implementación de
              los protocolos y/o guías de manejo conciliados entre el PSS/PTS y la ERP.12. Reportar a la
              Superintendencia Nacional de Salud los prestadores que no cumplan con el reporte oportuno, confiable,
              suficiente y con la calidad mínima aceptable de la información necesaria para la operación del sistema de
              monitoreo, de los sistemas de información del sector salud, o de las prestaciones de salud (Registros
              Individuales de Prestación de Servicios) 13. Realizar la evaluación de desempeño del prestador primario y
              reportar los resultados al finalizar el periodo contractual al PSS/PTS 14. Verificar la veracidad de la
              información reportada por el PSS/PTS en el marco de las obligaciones definidas en el presente contrato.
            </div>
            ...
            <div class="minuta_texto">
              ...
              <span class="minuta_paragrafo">PARÁGRAFO PRIMERO. </span>La habilitación del servicio prestado debe
              mantenerse durante la suscripción, ejecución y hasta la expiración del presente acuerdo de voluntades y la
              de sus prórrogas.
              <span class="minuta_paragrafo">PARÁGRAFO SEGUNDO. </span>En caso de prórrogas o renovaciones automáticas
              de los acuerdos de voluntades, antes del inicio del periodo de prórroga o renovación, se deberá actualizar
              la nota técnica en los casos que aplique, teniendo en cuenta su monitoreo y evaluación, de acuerdo con el
              periodo contractual, igualmente se tendrá en cuenta el ajuste de tarifa en el marco de la negociación
              entre las partes, sobre el límite determinado por el gobierno nacional, para cada vigencia. A falta de
              acuerdo se aplicará lo dispuesto en el parágrafo primero del artículo 2.5.3.5.3 del Decreto 780 de 2016,
              sin perjuicio de los acuerdos que surjan de la autonomía de la voluntad, la libertad de contratación y la
              libertad de configuración contractual entre las partes.
            </div>
            ...
            <div class="minuta_texto">
              ...
              perjuicio de los ajustes que se generan como consecuencia del proceso de auditoría realizado por parte del
              a ERP de acuerdo con el Anexo 21 que hace parte integral del presente contrato y del proceso normal de
              glosas conciliadas y debidamente aceptadas o levantadas al igual que los descuentos que apliquen por los
              recobros respectivos. De igual manera, el valor del contrato podrá variar según los valores que la ERP
              reconozca como incentivos económicos pactados por cumplimiento de indicadores o por ejecución de las
              actividades concertadas o por los valores descontados por incumplimientos de los mismos. El valor del
              presente contrato será el resultado de multiplicar el número de actividades estipuladas (CUPS) por el
              costo medio de cada actividad, multiplicado por la vigencia del contrato en meses. Estos valores se
              describen en la Nota Técnica.
              <span class="minuta_paragrafo">PARÁGRAFO PRIMERO. </span>La base del cálculo del valor del contrato es
              ...
              voluntades y sus probabilidades de uso 3. Costos acordados para cada servicio o tecnología en salud, de
              acuerdo con las diferentes modalidades de prestación de los servicios de salud.
            </div>
            ...
            <div class="minuta_clausula">Cláusula 7. población afiliada objeto del contrato</div>
            <div class="minuta_texto">
              La población objeto de cobertura del presente contrato es la población activa afiliada a la ERP, la cual
              se encuentra descrita en el Anexo 5 (Nota Técnica y Anexo 21 (Anexo Técnico).
            </div>
            ...
            <div class="minuta_texto">
              ...
              los criterios científicos de las Guías de Práctica Clínica que se listan en el Anexo 12 (Relación de Guías
              de Práctica Clínica y Protocolos de Atención) y de las Rutas de Atención Integral que se listan en el
              Anexo 13, los medicamentos según sus presentaciones y precios contenidos en el Anexo 14 y los insumos,
              suministros y demás tecnologías que se listan en el anexo 15. Además de todos los servicios descritos en
              la Nota Técnica anexa a este contrato.
            </div>
            ...
            <div class="minuta_texto">
              ...
              según la modalidad descrita en la portada del acuerdo de voluntades. La Tarifa de los servicios y
              tecnologías a proveer para el caso de modalidades de pago prospectivas se calculará de acuerdo con la nota
              técnica que hace parte integral de este acuerdo de voluntades. Los plazos de pago son los establecidos en
              la Ley 1122 de 2007, artículo 13, literal d; Ley 1438 de 2011, artículo 56 y 57; Ley 1231 de 2008; Ley
              2024 de 2020; Decreto 173 3 de 2020; Decreto 441 de 2022, y demás normas que modifiquen, adicionen o
              sustituyan.
              <span class="minuta_paragrafo">PARÁGRAFO PRIMERO. </span>
              Las partes acuerdan que en los contratos bajo la modalidad de pago global prospectivo se efectuará un pago
              del 80% del valor mensual del contrato y se mantendrá un 20% de este como reserva o provisión para los
              respectivos descuentos según auditoría, evaluación, recobros, lo cual estará sujeto al resultado de las
              conciliaciones realizadas y que en caso de ejecución superior al 80% este será pagado de acuerdo a la
              proporción de ejecución demostrada.
            ...
            <div class="minuta_texto">
              ...
              técnica que hace parte integral de este acuerdo de voluntades. Los plazos de pago son los establecidos en
              la Ley 1122 de 2007, artículo 13, literal d; Ley 1438 de 2011, artículo 56 y 57; Ley 1231 de 2008; Ley
              2024 de 2020; Decreto 1733 de 2020; Decreto 441 de 2022, y demás normas que modifiquen, adicionen o
              sustituyan.
              <span class="minuta_paragrafo">PARÁGRAFO PRIMERO. </span>El pago se realizará mediante transferencia
              electrónica al número de cuenta donde el PSS/PTS sea titular y que haya sido reportada por el PSS/PTS
              dentro de los anexos contractuales.
            </div>

            <div class="minuta_clausula">Cláusula 12. Tarifas.</div>
            <div class="minuta_texto">
              Las tarifas de los servicios son las pactadas en la nota técnica para las modalidades de pago prospectivo
              y para los servicios y tecnologías no
              incluidos en la misma se reconocerán bajo la figura de la homologación, cuando aplique; y los no
              homologables se reconocerán bajo la modalidad de pago por evento según las tarifas pactadas previamente,
              en cuyo caso se realizará a través del sistema habitual del proceso establecido por la ERP. Para todo
              servicio adicional excluido de la Nota Técnica y sin homologación, no contemplados en los Anexos 14 y 15,
              se procederá a su liquidación conforme a las tarifas pactadas.
              <span class="minuta_paragrafo">PARÁGRAFO PRIMERO. </span>Las tarifas detalladas en la nota técnica podrán
              ser modificadas durante la vigencia contractual a través de un Otrosí al contrato, suscrito por los
              representantes legales de las partes. En caso de prórroga o renovación automática se deberá actualizar la
              nota técnica en los casos que aplique, teniendo en cuenta su monitoreo y evaluación, de acuerdo con el
              periodo contractual, igualmente el incremento de tarifa será negociable anualmente entre las partes sobre
              ...
              configuración contractual entre las partes.
            </div>
            ...
            <div class="minuta_texto">
              ...
              modifiquen, adicionen o sustituyan. EL PSS realizará el recaudo del copago, cuotas moderadoras o cuotas de
              recuperación de acuerdo con la validación que realice en el módulo dispuesto por la ERP y deberá
              descontarlo del valor de la factura, especificando este ítem en la misma y en los RIPS de la factura. Será
              obligación especial del PSS, llevar un registro del recaudo de dichos copagos y cuotas moderadoras en los
              tiempos definidos por las normas legales con el fin de soportar los procesos de auditoría que haya lugar.
              <span class="minuta_paragrafo">PARÁGRAFO PRIMERO. </span>En el evento y ante la imposibilidad de pago por
              parte del afiliado, el PSS está obligado a soportar y reportar ante la ERP el no pago por parte del
              usuario, evento en el cual corresponderá a esta reconocer y pagar dicha suma y adelantar el cobro al
              usuario. El PSS reportará a la ERP dicha situación mediante formato de notificación que maneje el PSS o el
              formato que sea definido por la ERP. El formato de no recaudo debe adjuntarse a la factura y sus soportes.
              Este formato de notificación deberá ir firmado por el afiliado y por el funcionario encargado del PSS, con
              los datos mínimos de identificación y de contacto actualizados, como constancia, y en señal del
              conocimiento previamente informado, sobre la aplicación de las cuotas moderadoras y/o copagos a que está
              sujeto por los servicios prestados.
              <span class="minuta_paragrafo">PARÁGRAFO SEGUNDO. </span>El PSS en todos los casos que el afiliado
              manifieste la imposibilidad de pago, propondrá la suscripción de acuerdo de pago a los afiliados. Sólo
              podrá considerarse como parte del pago a estas cuando exista un recaudo efectivo de su valor.
              <span class="minuta_paragrafo">PARÁGRAFO TERCERO. </span>El PSS deberá abstenerse de cobrar a los
              afiliados copagos, cuotas moderadoras y de recuperación, de conformidad con las exclusiones establecidas
              en el Acuerdo 260 de 2004 y el Decreto 1562 de 2022 y demás normas que lo modifiquen, adicionen o
              sustituyan.
            </div>
            ...
            <div class="minuta_texto">
              ...
              <span class="minuta_paragrafo">PARÁGRAFO PRIMERO. CORRESPONDENCIA ENTRE RIPS CON GPC, PROTOCOLOS Y RIAS.
              </span>Los servicios y tecnologías reportadas en los RIPS que se anexen mensualmente a la factura
              corresponderán a las GPC, Protocolos y RIAS contenidas en estos Anexos en cuanto a las cantidades y dosis
              recomendadas.
              <span class="minuta_paragrafo">PARÁGRAFO SEGUNDO. ACTUALIZACIÓN DE LAS GPC Y RIAS. </span>Las partes del
              contrato revisarán cada año los listados anexos según las nuevas evidencias científicas surgidas. Se
              entenderán automáticamente adoptados los servicios y tecnologías a que se refieren las GPC y las RIAS del
              Ministerio de Salud / Instituto de Evaluación de Tecnologías en Salud IETS, en la medida en que se vayan
              actualizado, no obstante, los precios de los nuevos servicios o tecnologías sugeridas por las
              actualizaciones deberán pactarse mediante un otrosí que modifique los Anexos 5 y 14 del presente contrato.
            </div>

            <div class="minuta_clausula">Cláusula 15. Rutas Integrales de Atención en Salud.</div>
            <div class="minuta_texto">
              El PSS/PTS garantizará la prestación de los servicios de salud y el suministro de medicamentos, insumos y
              demás tecnologías en salud según el listado de RIAS del Anexo 13. El PSS/PTS se compromete a cumplir con
              los lineamientos técnicos y operativos de las RIAS adoptadas por el ministerio de salud y protección
              social y que forman parte integral del presente contrato. La prestación o provisión de servicios y
              tecnologías de salud relacionados con la implementación de las RIAS que el Ministerio de Salud y
              Protección Social haya definido como de obligatorio cumplimiento; las priorizadas por la entidad
              responsable de pago de acuerdo con la caracterización poblacional o el análisis de la situación en salud
              que esta realice; la gestión de eventos y condiciones en salud priorizados a través de la política
              pública, y todos aquellos que así se haya previsto por la normatividad.
            </div>
            ...
            <div class="minuta_texto">
              ...
              previa de servicios. Para los servicios por fuera de la nota técnica y los no homologables, serán
              prestados bajo la modalidad de evento, el PSS/PTS solicitará autorización del servicio según los tiempos y
              mecanismos descritos en el marco normativo vigente, mediante los canales de contacto descritos en el Anexo
              17. La ERP expedirá la autorización a través de un canal informático transaccional y notificará al PSS/PTS
              y usuario dentro de los tiempos establecidos por el marco normativo vigente.
              <span class="minuta_paragrafo">PARÁGRAFO PRIMERO. AUTORIZACIÓN DE SERVICIOS POR EVENTO. </span>Para los
              servicios no incluidos y no homologables en el presente acuerdo de voluntades, serán prestados mediante la
              modalidad de evento, la duración de las autorizaciones expedidas para estos será de 90 días luego de su
              expedición. En caso de no haber sido prestado el servicio en ese término, el PSS/PTS deberá justificar a
              la ERP los motivos por los que el servicio no se prestó durante la vigencia de esta, y la ERP definirá la
              ...
              los usuarios. No habrá lugar a la solicitud de autorización para la población wayuu y lo dispuesto en los articulos 4 y 5 de la resolución 2811 de 2022
               y para la atención
              integral del cáncer infantil o de adultos o de VIH/Sida de conformidad con el marco normativo vigente
              descrito en el Anexo 1. Esta prohibición aplica igualmente para evitar la generación de autorizaciones
              internas por parte del PSS/PTS en la prestación de los servicios objeto del contrato.
            </div>

            <div class="minuta_clausula">Cláusula 17. Nota técnica.</div>
            <div class="minuta_texto">
              ...
              con lo definido en el presente contrato, según las condiciones del PSS/PTS. La ERP reconocerá al PSS/PTS
              bajo la modalidad de Pago Global Prospectivo un valor por persona afiliada, de la población asignada a
              este contrato, teniendo como base para su cálculo la nota técnica, el cual establece la frecuencia de uso
              de actividades agrupadas, el costo medio de la actividad agrupada, dando como resultado un PGP agrupado
              por actividad para el período anual inmediatamente siguiente de los usuarios de la ERP del territorio o
              grupo poblacional asignado, y lo estipulado en las normas vigentes que regulan la materia.
              <span class="minuta_paragrafo">PARÁGRAFO SEGUNDO. MECANISMO DE AJUSTE DE RIESGO FRENTE A LAS DESVIACIONES
                DE LA NOTA TÉCNICA. </span>Se constituye como de cumplimiento obligatorio para el PSS/PTS el rango
              entre 90% a 110% de lo estipulado en la Nota Técnica anexa al presente contrato. Con el objeto de mitigar
              el impacto financiero que se pueda generar con ocasión de las desviaciones encontradas por la ERP o por
              solicitud del PSS/PTS durante la ejecución del acuerdo de voluntades que hubieren afectado las frecuencias
              de uso y costos finales de la atención, estas serán revisadas conforme a la actualización de la
              caracterización poblacional presentada por la ERP a la fecha de la revisión. El mecanismo de ajuste de
              riesgo se especifica en el anexo denominado Nota técnica que hace parte integral del presente acuerdo de
              voluntades.
              <span class="minuta_paragrafo">PARÁGRAFO TERCERO. DESCUENTOS. </span>Las partes acuerdan que se realizarán
              descuentos sobre el valor del presente contrato en los siguientes eventos: 1. Si el PSS/PTS no cumple con
              las metas establecidas en los anexos de evaluación de indicadores de desempeño, porcentajes de ejecución,
              cumplimiento de actividades por agrupador, incentivos y glosas. 2. También se aplicarán descuentos por
              concepto de recobros por servicios prestados por otro prestador conforme al valor establecido en la nota
              técnica y/o cuando se disminuye el número de personas sujetas a este convenio. 3. Cuando la Administradora
              de los Recursos del Sistema General de Seguridad Social en Salud -ADRES- ordene el reintegro de recursos
              por parte de la ERP por afiliados fallecidos. El PSS/PTS deberá devolver proporcionalmente, a la ERP, los
              recursos que por cuenta de tales afiliados recibió desde su fallecimiento y en los casos que se evidencie
              prestación de servicios a usuarios fallecidos podrá ser descontado teniendo en cuenta la falta de
              validación de derechos por parte del PSS/PTS. 4. Para la aplicación de los descuentos se dará aplicación
              al procedimiento establecido en la Resolución 3253 de 2009 en el Anexo Técnico Manual Único de Glosas,
              Devoluciones y respuestas , de acuerdo con el Anexo 21 (Anexo Técnico PGP), de acuerdo con la Resolución
              3047 de 2008 modificada por la Resolución 416 de 2009 y las demás normas que lo adicionen, modifiquen o
              sustituyan.
            </div>

            <div class="minuta_clausula">Cláusula 18. Mecanismos de evaluación de nota técnica.</div>
            <div class="minuta_texto">
              En los contratos de modalidades de pago prospectivo la nota técnica se evaluará mensualmente de
              conformidad con el reporte de actividades de PGP cargadas en el modulo de Génesis, RIPS validados para los
              contratos prospectivos, que se radiquen con las facturas, y de manera trimestral se determinará su
              cumplimiento o desviación en cuanto a porcentajes de ejecución de actividades por agrupador de la nota
              técnica, frecuencias y valores, población susceptible, con el fin de determinar la necesidad de ajustes en
              los mismos, a través de mecanismos de corrección de riesgo frente a las desviaciones de la nota técnica
              descritos en el Anexo 5, Anexo 11 y Anexo 21.
              <span class="minuta_paragrafo">PARÁGRAFO PRIMERO. CONCILIACIÓN PARCIAL TRIMESTRAL. </span>En los contratos
              de modalidades de pago prospectivo, se realizará una conciliación parcial trimestral. Los saldos a favor
              y/o en contra identificados para cada servicio se irán acumulando hasta el final del contrato, dejando
              actas de conciliación parcial trimestral suscritas por las partes autorizadas por cada entidad. Durante la
              ...
              evaluar el comportamiento de la ejecución de la Nota Técnica (Anexo 5) trimestralmente:
              <strong> 1. Variación en la población mensual. </strong>
              Si bien el valor pagado mensualmente es una doceava parte del valor total del contrato, cuando en la
              población afiliada objeto del contrato, se evidencie una variación en la población asignada al PSS/PTS,
              sea esta por fallecimientos, retiros y/o nuevos ingresos de usuarios, se realizará un ajuste en el valor
              reconocido mensual al PSS/PTS, correspondiente al monto calculado por usuario por mes.
              <strong> 2. Variación en la ejecución. </strong>
              En el evento que, al momento del seguimiento de la ejecución del contrato, las partes determinen que la
              ejecución es inferior al 90% del presupuesto asignado, la ERP sólo reconocerá el porcentaje ejecutado y
              aplicará los descuentos que correspondan. Por su parte, si la ejecución del presente contrato supera el
              110% del valor contratado,no se reconocerá ningún valor adicional al convenido. Esto acorde con la
              evaluación de los RIPS y los servicios registrados en el aplicativo definido por la ERP. 3. Cuando la
              ejecución durante el período evaluado se encuentre en el rango entre el 90% y el 110% del valor convenido,
              el riesgo será compartido entre las partes y se pagará el 100% del valor acordado 4. Los ajustes al valor
              del contrato aplicarán a partir del mes siguiente a aquel en que las partes realizaron la validación No se
              efectuarán ajustes retroactivos. Si como consecuencia de los mismos quedaren valores pendientes por
              reconocer entre las partes después de terminado el contrato, los mismos se consignarán en el acta final de
              liquidación.
            </div>

            <div class="minuta_clausula">Cláusula 19. Mecanismos de equilibrio financiero.</div>
            <div class="minuta_texto">
            ...
            <div class="minuta_clausula">Cláusula 20. Descuentos por insuficiencia de la información contenida en los
              RIPS y registro de actividades de PGP.</div>
            <div class="minuta_texto">
              A partir del mes inmediatamente siguiente al cierre de cada trimestre contado a partir de la fecha de
              inicio del presente contrato, la ERP evaluará la información contenida en los RIPS y registro de
              actividades de PGP, considerando la población objeto de este al momento de la evaluación, dependiendo del
              porcentaje de ejecución de las actividades establecidas en la nota técnica que acredite el PSS/PTS, de
              acuerdo con las condiciones que más adelante se indican, para determinar el valor a descontar. Se tendrá
              en cuenta el valor acumulado del contrato para el trimestre correspondiente. La aplicación efectiva del
              descuento tendrá lugar en el mes siguiente a aquel en que finalizó el proceso de evaluación de la
              información.

              <span class="minuta_paragrafo">PARÁGRAFO PRIMERO. </span>Si como resultado de la evaluación de la
              información contenida en los RIPS y registro de actividades de PGP a través del módulo dispuesto por la
              ERP para tal fin que realiza la ERP, se evidencia que la ejecución de la nota técnica sea mayor a 110%,
              las partes procederán a revisar la misma. Resultado de dicha revisión, podrán acordar una nueva nota
              técnica, la cual deberá constar por escrito en el correspondiente Otrosí, el cual no aplicará de manera
              retroactiva.
              <span class="minuta_paragrafo">PARÁGRAFO SEGUNDO. </span>Si durante dos períodos consecutivos como
              resultado de la evaluación de la información contenida en los RIPS y registro de actividades de PGP, se
              encuentra que la ejecución de la nota técnica está en el rango de 0% a 45%, la ERP quedará facultada para
              dar por terminado el presente contrato, dando aviso por escrito al PSS/PTS con al menos 30 días de
              antelación respecto de la fecha en que se hará efectiva la terminación o tendrá la opción de restructurar
              la nota técnica del contrato y notificarlo al PSS/PTS con 30 días de antelación respecto de la fecha en
              que se hará efectivo el nuevo valor. De no estar de acuerdo con el nuevo valor, el PSS/PTS podrá dar por
              terminado el contrato bastando el aviso a la ERP notificándolo con al menos 30 días de antelación respecto
              a la fecha de terminación deseada.
              <span class="minuta_paragrafo">PARÁGRAFO TERCERO. </span>El descuento a que hace referencia la presente
              cláusula será aplicado a la facturación corriente que se encuentre en procesamiento, o a las cuentas por
              pagar por parte de la ERP al PSS/PTS al momento en que se tenga el resultado de la evaluación de la
              información contenida en los RIPS y registro de actividades de PGP. En este caso, la ERP notificará al
              PSS/PTS las facturas a las cuales se le aplicó el descuento.
              <span class="minuta_paragrafo">PARÁGRAFO CUARTO. </span>Si como resultado de la revisión del último
              trimestre de ejecución del contrato, se identifican descuentos a aplicar al PSS/PTS, y no existiere
              facturación corriente, en procesamiento o cuentas por pagar por parte de la ERP, las partes dejarán
              constancia de este hecho en el acta de liquidación del contrato, así como de las condiciones en que
              procederá la devolución de los valores correspondientes por parte del PSS/PTS. Asimismo, se establece que
              dicha acta de conciliación, una vez suscrita por ambas partes, otorgará mérito ejecutivo para que la ERP
              ejecute el cobro de los valores correspondientes al PSS/PTS, sin requerir notificación adicional ni
              constitución en mora, renunciando ambas partes a cualquier requisito adicional para iniciar el proceso de
              cobro, de conformidad con lo estipulado en el presente contrato.
            </div>

            <div class="minuta_clausula">Cláusula 21. Descuentos por incumplimientos a las condiciones de atención de
              los afiliados.</div>
            <div class="minuta_texto">
              La ERP podrá descontar del valor del presente contrato, aquellos costos que se causen por atenciones que,
              estando incluidas en este contrato, deban ser autorizadas a otros PSS/PTS, en los siguientes eventos: 1.
              Cuando un afiliado estando activo y adscrito al PSS/PTS, deba recibir atención en una ciudad diferente a
              aquella en la que se prestan los servicios objeto del presente contrato, siempre y cuando en la ciudad no
              existiera una sede del PSS/PTS según relación del anexo 7, que preste el servicio requerido por el usuario
              oportunamente. El valor a descontar corresponderá a lo establecido y contratado según nota ténica. 2.
              Cuando el afiliado requiera algún servicio contratado y/o por algún motivo tenga una barrera de acceso y
              no le sea prestado el servicio requerido y contratado al PSS/PTS modelo en las instalaciones del PSS/PTS,
              o medie un fallo judicial taxativo que indique que la atención deba ser en un PSS/PTS diferente al
              contratado para el PGP. 3. En el evento en que se requiera el traslado del afiliado a otra institución por
              falta de oportunidad o no atención de este, para cualquiera de lo s servicios contratados.
              4. Reembolsos pagados por la ERP a los afiliados por servicios objeto del presente contrato y que no
              fueron
              garantizados por el PSS/PTS.
              <span class="minuta_paragrafo">PARÁGRAFO PRIMERO. </span>En el evento excepcional que el PSS/PTS no pueda
              cumplir con alguno de los servicios contenidos en el contrato, deberá direccionar el caso a la ERP para
              que esta garantice a través de su red de servicios la prestación de este al afiliado de manera oportuna.
              <span class="minuta_paragrafo">PARÁGRAFO SEGUNDO. </span>Para el caso de los descuentos de PGP, los
              valores pagados a otras instituciones se descontarán utilizando el siguiente procedimiento: 1. Según la
              evaluación mensual se aplicarán los descuentos trimestralmente de acuerdo con el tiempo de presentación de
              las facturas por parte del PSS/PTS al cual se direccionó el servicio no prestado por el PSS/PTS modelo..
              La ERP auditará las cuentas presentadas por este concepto en cuanto a validación de derechos, municipio de
              afiliación, notificación al PSS/PTS, cobertura de las atenciones por el PGP, pertinencia de la atención y
              respectivos soportes de la cuenta. Estos soportes serán remitidos al PSS/PTS para el descuento al PGP.2.
              El PSS/PTS dispondrá de 30 días calendario para hacer las aclaraciones a que haya lugar, de no existir
              comunicación escrita por parte del PSS/PTS, se dará por aceptado el descuento de PGP sin opción de reclamo
              posterior. En caso de existir diferencias, se realizará una reunión de conciliación para aclarar las
              objeciones y definir el descuento a aplicarse al PGP. Dicha conciliación se plasmará en un acta suscrita
              por las partes o por sus delegados.
              <span class="minuta_paragrafo">PARÁGRAFO TERCERO. </span>Para la aplicación de los descuentos, se acatará
              el procedimiento establecido en la Resolución 3252 de 2009 y el la Resolución 3047 de 2008 modificada por
              la Resolución 416 de 2009, así como las demás normas que las adicionen, modifiquen o sustituyan.
            </div>

            <div class="minuta_clausula">Cláusula 22. Supervisión del contrato</div>
            <div class="minuta_texto">
              ...
              <span class="minuta_paragrafo">PARÁGRAFO PRIMERO. DECLARACIONES DEL SUPERVISOR. </span>Con su visto bueno
              y en calidad de responsable técnico del contrato, el supervisor declara que: 1. La IPS se encuentra
              inscrita en el Registro Especial de Prestadores de Servicios de Salud -REPS- y dicho registro está
              vigente. 2. La IPS cumple con los requisitos legales que en materia de habilitación para la prestación de
              servicios de salud establece la Resolución 3100 de 2019 o aquella norma vigente que la modifique, adicione
              o sustituya, y garantiza la prestación de la totalidad de los servicios contratados. 3. La IPS cuenta con
              sedes habilitadas en los municipios descritos en el Anexo 7, para garantizar la prestación de los
              servicios objeto del contrato a sus afiliados en las condiciones de cobertura que exige la ley a las
              aseguradoras del SGSSS. 4. Las sedes en las cuales se prestarán los servicios de salud objeto del contrato
              cuentan con la evaluación realizada de conformidad con lo establecido en los procedimientos internos de la
              ERP y se encuentran vigentes al momento de la firma del acuerdo de voluntades. 5. Considerando el
              cumplimiento de los requisitos técnicos y legales específicamente respecto de la habilitación para la
              prestación de servicios de salud, gestionó ante el órgano competente de la ERP la aprobación de la
              presente contratación. 6. El acuerdo de servicios, el contrato y sus anexos, corresponden a lo negociado y
              autorizado por la ERP, y por lo tanto da visto bueno a la suscripción del presente documento.
              <span class="minuta_paragrafo">PARÁGRAFO SEGUNDO. RESPONSABILIDADES DEL SUPERVISOR. </span>Las
              ...
              conformidad con el Manual de Contratación, la terminación del contrato. 4. Brindar la información al área
              encargada para la liquidación del contrato dentro de los 4 meses siguientes a su terminación y gestionar
              la suscripción del acta respectiva. 5. En general, dar cumplimiento a las disposiciones del Manual de
              Contratación.
            </div>

            <div class="minuta_clausula">Cláusula 23. Coordinación de referencia y contrarreferencia.</div>
            <div class="minuta_texto">
              El PSS/PTS aplicará el Manual de Referencia y Contrarreferencia suministrado por la ERP de conformidad con
              los prestadores descritos en el Anexo 16 y utilizando los contactos descritos en el Anexo 17.
            </div>

            <div class="minuta_clausula">Cláusula 24. Indicadores de evaluación de la ejecución.</div>
            <div class="minuta_texto">
              ...
              de 2011, Resolución 1552 de 2013, Resolución 256 de 2016 de la Superintendencia Nacional de Salud, así
              como aquellas que la modifiquen, adicionen o sustituyan. Durante la vigencia del contrato, la ERP
              verificará que la prestación de servicios de salud objeto del presente contrato, se cumpla por parte del
              PSS/PTS, bajo las condiciones de accesibilidad, oportunidad, seguridad, pertinencia y continuidad
              establecidas en la normatividad aplicable en la materia. Para efectos de evaluar el cumplimiento del
              presente acuerdo de voluntades, el PSS/PTS se obliga a reportar a la ERP los indicadores de calidad, de
              gestión y de resultados descritos en el Anexo 9, Anexo 21 y en el marco normativo vigente descrito en el
              Anexo 1.
              <span class="minuta_paragrafo">PARÁGRAFO. ACTUALIZACIÓN DE INDICADORES E IMPREVISTOS. </span>En caso de
              ...
              condiciones se someterá a las normas de imprevisión del Código Civil y del Código del Comercio.
            </div>

            <div class="minuta_clausula">Cláusula 25. Proceso periódico de evaluación.</div>
            <div class="minuta_texto">
              ...
              Registro Individual de Prestaciones de Salud Y Registro de actividades de PGP en la plataforma diseñada
              por la ERP para tal fin.
              ...
              previstos en esta cláusula, el PSS/PTS deberá garantizar a la ERP el acceso a la historia clínica del
            ...
            <div class="minuta_clausula">Cláusula 26. Reportes obligatorios.</div>
            <div class="minuta_texto">
              PSS/PTS deberá reportar a la ERP dentro de los primero cinco (5) días HÁBILES de cada mes vencido: 1. Los
              Indicadores de calidad de la atención de salud establecidos en el Anexo 9, a través de los mecanismos que
              la ERP establezca; especialmente el reporte de la resolución 1552 de 2013 el cual deberá reportar de forma
              oportuna junto con el pantallazo de validación en la página de la Superintendencia Nacional de Salud el
              cual deberá ser enviado a la ERP por correo electrónico, como constancia de la realización del reporte de
              la información y adicionalmente deben cargarlo a través de la plataforma Génesis en el módulo salud/1552 .
              2. Los Indicadores de reporte obligatorio en las normas vigentes de la Superintendencia Nacional de
              Salud;3. Los casos de sospecha de reacciones adversas a medicamentos deben ser notificados en el formato
              del INVIMA. 4. Todos los reportes obligatorios del SIVIGILA según las pautas, formatos, manuales de
              vigilancia epidemiológica vigentes del Instituto; 5. La información de las actividades de protección
              específica y detección temprana (PEDT) en la estructura, formato y periodicidad determinada por el
              Ministerio de Salud y Protección Social, dentro de los veinte (20) primeros días de cada mes.
            </div>

            <div class="minuta_clausula">Cláusula 27. Mecanismos y plazos para la entrega y actualización de la
            ...
            <div class="minuta_texto">
              ...
              documento actualizado de cada uno de nuestros afiliados al correo nacional.arm1@cajacopieps.com, con el
              asunto Reporte de novedades - Actualización de documento. 2. El reporte deberá ir acompañado de una tabla
              en Excel con los siguientes datos del afiliado qu e presente la novedad: tipo de documento, número de
              documento, nombres y apellidos completos, dirección de residencia, teléfono (s), e-mail y soporte.
            </div>

            <div class="minuta_clausula">Cláusula 28. Facturación y glosas.</div>
            <div class="minuta_texto">
              EL PSS/PTS radicará antes a la ERP la Factura o Factura Electrónica de Venta (FEV) dentro de los plazos y
              ...
              <span class="minuta_paragrafo">PARÁGRAFO PRIMERO. CIRCULARES SOBRE REPORTES DE INFORMACIÓN. </span>Para
              ...
              <span class="minuta_paragrafo">PARÁGRAFO SEGUNDO. REPORTE DE RIPS. </span>PSS/PTS reportará a la ERP como
              requisito obligatorio para la radicación de la factura, los Registros Individuales de Prestación de
              Servicios de Salud RIPS con el detalle de servicio por cada usuario utilizando: 1. La clasificación única
              de procedimientos CUPS, 2. La codificación única que determine el Ministerio de La Protección Social para
              los insumos y dispositivos médicos, a los cuales el INVIMA haya otorgado registro sanitario. 3. Todos los
              medicamentos deberán ser reportados en códigos CUMS (expediente + consecutivo) según población afiliada
              objeto del contrato Invima vigente. Adicionalmente, los RIPS deben corresponder con los códigos y valores
              de los servicios, medicamentos e insumos definidos en la Nota Técnica.
              <span class="minuta_paragrafo">PARÁGRAFO TERCERO. FACTURACIÓN DEL ÚLTIMO MES DEL CONTRATO. </span>EL
              PSS/PTS deberá presentar las facturas por la prestación de servicios dentro de la misma vigencia del
              contrato y las atenciones del último mes, a más tardar al mes siguiente.
              <span class="minuta_paragrafo">PARÁGRAFO CUARTO. NOTIFICACIÓN DE PRESTACIÓN. </span>La
              prestación del servicio, entrega del medicamento o insumo, se deberá realizar finalizada la atención del
              afiliado en un periodo no mayor a tres días posteriores a esta, en el portal dispuesto para tal fin. Sin
              dicha validación se dará por no prestado el servicio o entregado el medicamento o insumo, lo que impedirá
              la radicación de la factura.
            </div>

            <div class="minuta_clausula">Cláusula 29. Plazos de pago.</div>
            <div class="minuta_texto">
            ...
            <div class="minuta_clausula">Cláusula 30. Mecanismos de solución de conflicto.</div>
            <div class="minuta_texto">
            ...
            <div class="minuta_clausula">Cláusula 31. Causales de terminación del contrato.</div>
            <div class="minuta_texto">
              ...
              debida forma y por escrito al PSS/PTS sin que medie justa causa para dicha omisión. 10. Cuando la
              ejecución de la nota técnica esté en el rango de 0% a 45% de acuerdo con la auditoría realizada de forma
              trimestral, la ERP quedará facultada para dar por terminado el presente contrato, dando aviso por escrito
              al PSS/PTS con al menos 30 días de antelación respecto de la fecha en que se hará efectiva la terminación.
              11. Cuando al PSS/PTS se le realice descuentos por concepto de recobros superiores al 10% mensual del
              valor del contrato. 12. Por cualquier situación donde alguna de las partes deje de hacer presencia en el
              municipio de prestación del servicio. 13. Cuando haya operado la condición resolutoria expresa. 14. Por
              resolución judicial debidamente ejecutoriada. 15. La ERP podrá terminar el contrato de manera unilateral
              si por causa de investigación administrativa, judicial o de vigilancia y control, el PSS/PTS resulte
              sancionado por acto que afecte el Código del buen Gobierno, la transparencia, la lealtad y confianza
              legítima de las partes. 16. La ERP podrá terminar el contrato de manera unilateral, cuando el PSS/PTS
              subcontrate sin su autorización. 17. Por las malas prácticas en las que pueda incurrir el PSS/PTS, por la
              inoportunidad en el servicio, falta de calidad, por cierre de las instalaciones donde presta servicio el
              PSS/PTS debido al paro, huelga promovida por trabajadores o por la comunidad, caso en el cual se podrá dar
              por terminado el presente acuerdo de voluntades con la simple comunicación expedida por la ERP. 18. Por
              vencimiento del plazo pactado. 19. Por la no entrega de informes requeridos por la ERP para el
              cumplimiento de sus funciones como aseguradora dentro del SGSSS, o la entrega inoportuna o incompleta de
              estos por parte del PSS/PTS. 20. Por el uso indebido de las bases de datos de la ERP por parte del
              PSS/PTS. 21. La ERP podrá dar por terminado unilateralmente el contrato sin que esto de lugar a
              indemnización, cuando el PSS/PTS no diere cumplimiento a las disposiciones legales relacionadas con la
              prevención y control al lavado de activos, el financiamiento del terrorismo y la financiación de la
              proliferación de armas de destrucción masiva nacionales o internacionales que les sean aplicables. 22.
              Cuando el PSS/PTS figure en las listas de la OFAC y/o en las listas nacionales e internacionales
              relacionadas con actividades ilícitas, estando la ERP facultado para efectuar las verificaciones que
              considere pertinentes en bases de datos públicos o privadas (de orden nacional o internacional) donde se
              relacionan personas presuntamente vinculadas a cualquier actividad ilícita. 23. Cuando exista en contra
              del PSS/PTS una sentencia judicial en firme que lo condene por la comisión de los delitos de lavado de
              activos, financiación del terrorismo y la financiación de la proliferación de armas de destrucción masiva
              nacionales o internacionales o se encuentren vinculados en investigaciones o procesos penales por dichos
              delitos, o exista información pública con respecto a tales personas que puedan colocar a la ERP frente a
              un riesgo legal o reputacional. 24. Cuando se presenten elementos que puedan representar para la ERP,
              riesgos reputacionales, legales, operativos o de contagio relacionados con el lavado de activos la
              financiación del terrorismo y la financiación de la proliferación de armas de destrucción masiva
              nacionales o i nternacionales. 25. Cuando se presenten elementos que conlleven a dudas fundadas sobre la
              legalidad de las operaciones del PSS/PTS, la licitud de sus recursos o que el PSS/PTS ha efectuado
              transacciones u operaciones destinadas a dichas actividades o a favor de personas relacionadas con las
              mismas. 26. Cuando se presenten inconsistencias, discrepancias o falsedades en la documentación e
              información aportada por el PSS/PTS para la celebración y ejecución del contrato y que conlleve a dudas
              fundadas sobre la legalidad de las operaciones del PSS/PTS. 27. Por decisión unilateral por parte de la
              ERP, con previo aviso de treinta (30) días calendario, sin que haya lugar a indemnización alguna.
              <span class="minuta_paragrafo">PARÁGRAFO PRIMERO. REQUERIMIENTO PARA TERMINACIÓN DEL CONTRATO </span>La
              ERP a través del supervisor de este contrato, requerirá por escrito al PSS precisándole el incumplimiento
              de una o varias de las obligaciones pactadas, exigiéndole que en un plazo no mayor a cinco (5) días
              hábiles contados a partir del recibo de la comunicación, presente las explicaciones correspondientes o
              según el caso, cumpla con lo pactado, informándole las consecuencias de no atender el requerimiento. Si
              vencido el plazo el PSS no responde, o sus explicaciones no son satisfactorias para la ERP, o no realiza
              las actividades correctivas solicitadas, la ERP quedará en libertad de terminar unilateralmente el
              contrato, y en este caso lo anunciará al PSS mediante comunicación escrita con una antelación no menor a
              30 días calendario respecto de la fecha de terminación deseada.
            ...
            <div class="minuta_clausula">Cláusula 33. Incentivos pactados.</div>
            <div class="minuta_texto">
              Las partes podrán pactar en el acta de Iniciación del Contrato el reconocimiento de incentivos de tipo
            ...
            <div class="minuta_clausula">Cláusula 34. Canales de relacionamiento.</div>
            <div class="minuta_texto">
            ...
            <div class="minuta_texto">
              ...
              designado para el cumplimiento del Contrato. En el evento, de acciones jurídicas legales contra la ERP ,
              se entenderá que el proceso no se puede desarrollar sin la presencia procesal del PSS.
            </div>

            <div class="minuta_clausula">Cláusula 36. Llamamiento en Garantía.</div>
            <div class="minuta_texto">
            ...
            <div class="minuta_clausula">Cláusula 37. Cesión.</div>
            <div class="minuta_texto">
              ...
              obligaciones emanados de la ejecución
              de este, será cedido de conformidad a lo establecido en el Artículo
              ...
              institucional.
              <span class="minuta_paragrafo">PARÁGRAFO SEGUNDO.</span> Las cesiones de créditos que suscriba el PSS/PTS
              con un tercero NO
              surtirán efectos sobre los créditos, saldos y/o facturas que se generen con ocasión de la ejecución del
              presente contrato, si no cuentan con la autorización expresa y por escrito de la ERP. La cesión requerirá
              de la suscripción de un contrato de cesión con las mismas disposiciones del actual sin que represente
              costo alguno para la ERP.
            </div>

            <div class="minuta_clausula">Cláusula 38. Régimen jurídico del contrato.</div>
            <div class="minuta_texto">
              El presente acuerdo de voluntades se rige por el derecho privado y el marco normativo descrito en el Anexo
              1. Le son aplicables los procesos precontractuales, contractuales y postcontractuales descritos en el
              Decreto 441 de 2022, adoptados en el Manual de Contratación de la ERP.
            </div>

            <div class="minuta_clausula">Cláusula 39. Cláusula penal pecuniaria.</div>
            <div class="minuta_texto">
              ...
              hubiese, podrá cobrarse por la vía ejecutiva, enunciando el PSS con la suscripción del presente contrato a
              requerimientos judiciales o extrajudiciales, de mane ra que este documento y la liquidación de los
            ...
            <div class="minuta_clausula">Cláusula 40. Prevención del lavado de activos y financiación del terrorismo
            </div>
            <div class="minuta_texto">
              ...
              relacionadas con la financiación del terrorismo. Las partes se obligan a re alizar todas las actividades
              ...
              otras, la ERP o el PSS/PTS puede terminar unilateralmente el acuerdo de voluntades sin que por este hecho
              ...
              ejerza auditoría para este, so pena, se reportará tal acción ante los entes de control, judiciales,
              fiscales y disciplinarios para que se inicien las investigaciones que correspondan.
              <span class="minuta_paragrafo">PARÁGRAFO PRIMERO. CONSULTA DE ANTECEDENTES. </span>El PSS/PTS autoriza a
              la ERP, la consulta, verificación en cualquier población afiliada objeto del contrato, listas restrictivas
              y públicas. El PSS/PTS deberá suministrar a la ERP toda la información acerca del origen de los fondos,
            ...
            <div class="minuta_clausula">Cláusula 41. Autorización del tratamiento de datos personales</div>
            <div class="minuta_texto">
              ...
              <span class="minuta_paragrafo">PARÁGRAFO PRIMERO. </span>El PSS/PTS se compromete a tratar los datos
              ...
              terminación del acuerdo de voluntades, el PSS/PTS deberá devolver o destruir la información de las bases
              de datos personales de acuerdo con las indicaciones de la ERP.
              ...
              </span>EL PSS/PTS deberá reportar e informar mensualmente a la ERP las novedades en la actualización de
              los datos de identificación, dirección, contacto, etc, de los usuarios que identifique, mediante el
              mecanismo que las partes adopten para la entrega y actualización de información. LAS PARTES pactan que
              recibirán notificaciones en los correos electrónicos reportados en el presente acuerdo de voluntades.
            </div>

            <div class="minuta_clausula">Cláusula 42. No relación laboral.</div>
            <div class="minuta_texto">
            ...
            <div class="minuta_clausula">Cláusula 43. Modificación, adición y cesión.</div>
            <div class="minuta_texto">
            ...
            <div class="minuta_clausula">Cláusula 44. Prohibiciones.</div>
            <div class="minuta_texto">
              ...
              contrato.5. Reusar materiales, insumos o dispositivos de tipo desechable o no reutilizable de acuerdo con
              el manual de uso y reuso e incumplir con los estándares de reuso del fabricante.
            </div>

            <div class="minuta_clausula">Cláusula 45. Restricciones para contratar.</div>
            <div class="minuta_texto">
              ...
              <span class="minuta_paragrafo">PARÁGRAFO PRIMERO. INHABILIDADES E INCOMPATIBILIDADES. </span>Las partes
              ...
              contrato por parte de la ERP.
              <span class="minuta_paragrafo">PARÁGRAFO SEGUNDO. AUTORIZACION DE TOPES PRESUPUESTALES DEL PSS/PTS.
              </span>
              ...
              habilite para obligarse con el valor contratado.
            </div>

            <div class="minuta_clausula">Cláusula 46. Causales de suspensión</div>
            <div class="minuta_texto">
              ...
              numeral 1 de esta cláusula y sólo en lo que legalmente pueda corresponder, la suspensión del contrato no
              genera indemnización a favor de alguna de las partes.
            </div>

            <div class="minuta_clausula">Cláusula 47. Origen de los recursos</div>
            <div class="minuta_texto">
            ...
            <div class="minuta_clausula">Cláusula 48. Régimen de transparencia.</div>
            <div class="minuta_texto">
            ...
            <div class="minuta_clausula">Cláusula 49. Anexos</div>
            <div class="minuta_texto">
            ...
            <br>
            <div class="minuta_clausula">Cláusula 50. Domicilio contractual.</div>
            ...
            <div class="minuta_clausula">Cláusula 51. Perfeccionamiento del contrato.</div>
            <div class="minuta_texto">
            ...
            <div class="minuta_clausula">Cláusula 52. Efecto</div>
            <div class="minuta_texto">
        ...
        <th class="report-header-cell">
          <div class="header-info text-left d-flex">
            ...
            <div class="text-bold7">
              ...
              PRESTACION DE SERVICIOS DE SALUD MEDIANTE LA MODALIDAD DE PRESUPUESTO GLOBAL PROSPECTIVO
        ...
        <td>
          <div id="minuta_contrato">
            ...
            <div class="minuta_anexo_parrafo">
              ...
              bien las buenas prácticas en materia de seguridad de la información.
            </div>
            ...
            <div class="minuta_anexo_parrafo">
              ...
              Comunicar a CAJACOPI EPS SAS, en los ocho (8) días calendario siguientes al momento en el que tenga
