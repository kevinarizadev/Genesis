...
<body ng-controller="caratulaController">
    ...
    <table id="table1">
        <tr>
            <th>
                <img src="https://genesis.cajacopieps.com/assets/images/cajacopi.png" width=100px; height="60px">
            </th>
    ...
    <table id="table3">
        ...
        <tr>
            <td colspan="2"><b>1.1 CONTRATANTE:</b> CAJA DE COMPENSACIÓN FAMILIAR CAJACOPI ATLANTICO</td>
            <td><b>NIT:</b> 890.102.044</td>
            <td>CCF-055</td>
        </tr>
        <tr>
