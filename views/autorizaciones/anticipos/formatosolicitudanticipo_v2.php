...
<body ng-controller="ControladorIMP" ng-init="Hoja='ANT'">
  <table id="table1" width="100%" style="border: #FFF;">
    ...
    <tr style="font-weight:600;">
      ...
      <td colspan="6" rowspan="2" style="width: 60%;text-align: center;font-weight:600;padding:0.1% 0%;">FORMATO DE
        SOLICITUD DE ANTICIPO</td>
      <td colspan="2">
        Código: RP-FR-11
      </td>
    </tr>
    ...
    <tr style="font-weight:600;">
      <td colspan="1" style="background-color:#deeaf6;padding:1% 0%;">JUSTIFICACIÓN TÉCNICO CIENTÍFICA DEL SERVICIO
        SOLICITADO</td>
    ...
    <tr style="font-weight:600;">
      ...
      <td colspan="8">SOLICITUD DE SERVICIO, COPIA DE HISTORIA CLINICA, FORMATO MIPRES, FOTOCOPIA DE CEDULA DE
        CIUDADANIA, FOTOCOPIA DEL ADRES ACTUALIZADO, COTIZACIONES, COPIA DE LA TUTELA, INCIDENTE O MEDIDA PROVISIONAL
        (SI ES EL CASO), CERTIFICACIÓN BANCARIA, RUT, CERTIFICACIÓN DE EXISTENCIA Y REPRESENTACIÓN LEGAL, HABILITACIÓN
    ...
    <tr style="font-weight:600;background-color:#deeaf6;text-align:center;">
      <td colspan="4">APROBACIÓN DEL COORDINADOR NACIONAL DE AUTORIZACIONES</td>
      <td colspan="5">APROBACIÓN DEL SUBGERENTE NACIONAL DE SALUD</td>
    </tr>
    ...
    <tr style="font-weight:600;background-color:#deeaf6;text-align:center;">
      <td colspan="9">APROBACIÓN DEL SUBGERENTE GENERAL</td>
    </tr>
    <tr style="font-weight:600;text-align:center;">
