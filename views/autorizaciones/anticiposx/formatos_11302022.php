...
<body ng-controller="ControladorIMP" ng-init="Hoja='ANT'">
    <div style="padding-left:50px;padding-right:20px">
        <table id="Tabla_Titulo" width="100%" style="text-align:left;;">
            <tr>
                <th style="width: 10%;border-bottom-width: 1px"><img src="https://genesis.cajacopieps.com//assets/images/cajacopi.png" width=105px; height="50px">
    ...
    <div style="padding:0px 20px">
        <table id="table_Cuerpo" width="100%" style="border: #FFF;">
            ...
            <tr>
                <td colspan="2">
                    <span><b>1.1 CONTRATANTE: </b>CAJA DE COMPENSACION FAMILIAR CAJACOPI ATLANTICO</span>
                </td>
                <td colspan="1">
                    <span><b>NIT: </b>890.102.044</span>
                </td>
                <td colspan="1">
