        ...
        <table width=718 cellpadding=7 cellspacing=0 style="page-break-before: always">
            <tr>
                <td colspan=11 width=702 height=88 valign=top
                    ...
                    <p align=center style="margin: 0in"><img src="../../assets/images/cajacopi.png" name="imagen 3"
                            align=bottom width=81 height=53 border=0>
                        <font face="arial, serif">
                            <font size=4><b>FORMATO
                                    ÚNICO DE ATENCIÓN DE TELEORIENTACIÓN
                                    <img src="../../assets/images/cajacopi.png" name="imagen 4" align=bottom width=81 height=53 border=0>
                                    </b></font>
                        </font>
                    </p>
