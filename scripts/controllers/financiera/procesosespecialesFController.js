      ...
      if ($scope.tipodeItem == "0") {
        ...
        switch ($scope.tipodeItem) {
          ...
          case "78": //Cargue de Bases de BDUA Contributivo
            ...
            $scope.show_municipio = false;
            break;
          case "80": // Reporte de Informes para Comite de Pagos
            $scope.show_ano = true;
            $scope.show_regimen = false;
            $scope.show_ciclo = false;
            $scope.show_mensual = false;
            ...
            $scope.cicloMensual = "Mensual";
            $scope.cicloTrimestre = false;
            $scope.Nombrereporte = "Reporte de Informes para Comite de Pagos";
            $scope.contenido1 = true;
            $scope.show_ubicacion = false;
            $scope.show_concepto = false;
            $scope.show_fecha_recibico = false;
            ...
            $scope.show_municipio = false;
            break;
          case "81": ////Reporte de pagos para pagia circular 017
            $scope.show_ano = true;
            $scope.show_regimen = false;
            $scope.show_ciclo = false;
            $scope.show_mensual = true;
            ...
            $scope.cicloMensual = false;
            $scope.cicloTrimestre = false;
            $scope.Nombrereporte = "Reporte de pagos para pagia circular 017";
            $scope.contenido1 = true;
            $scope.show_ubicacion = false;
            $scope.show_concepto = false;
            $scope.show_fecha_recibico = false;
          ...
          case "82": // Archivo Tipo FT001
            ...
            $scope.cicloMensual = "Mensual";
            $scope.cicloTrimestre = false;
            $scope.Nombrereporte = "Archivo Tipo FT001";
            $scope.contenido1 = true;
            $scope.show_ubicacion = false;
            $scope.show_concepto = false;
            $scope.show_fecha_recibico = false;
          ...
          case "83": // Archivo Tipo FT003
            ...
            $scope.cicloMensual = "Mensual";
            $scope.cicloTrimestre = false;
            $scope.Nombrereporte = "Archivo Tipo FT003";
            $scope.contenido1 = true;
            $scope.show_ubicacion = false;
            $scope.show_concepto = false;
            $scope.show_fecha_recibico = false;
          ...
          case "85": // Archivo Tipo FT005
            ...
            $scope.cicloMensual = "Mensual";
            $scope.cicloTrimestre = false;
            $scope.Nombrereporte = "Archivo Tipo FT005";
            $scope.contenido1 = true;
            $scope.show_ubicacion = false;
            $scope.show_concepto = false;
            $scope.show_fecha_recibico = false;
          ...
          case "86": // Archivo Tipo FT0011
            ...
            $scope.cicloMensual = "Mensual";
            $scope.cicloTrimestre = false;
            $scope.Nombrereporte = "Archivo Tipo FT0011";
            $scope.contenido1 = true;
            $scope.show_ubicacion = false;
            $scope.show_concepto = false;
            $scope.show_fecha_recibico = false;
        ...
        switch ($scope.tipodeItem) {
          case "54": // Archivo Tipo 130 - Auditoria (Radicacion)
            if ($scope.regimen == "" || $scope.nit == "" || $scope.fecha_inicio == "" || $scope.fecha_final == "" || $scope.departamento == "" || $scope.municipio == "") {
              swal({
                title: "Mensaje",
                text: "No se puede gestionar proceso si no completa todos los campos requeridos (*).",
                type: "warning",
              });
              $scope.contenido1 = true;
              return
          ...
          case "80":  //Reporte de Informes para Comite de Pagos
            if ($scope.anno == "") {
              ...
              if ($scope.anno == "" || $scope.anno == undefined || $scope.periodo == "" || $scope.periodo == undefined) {
                swal({
                  title: "Mensaje",
                  text: "No se puede cargar archivo si no completa todos los campos requeridos (*).",
                  type: "warning",
                ...
                swal({
                  title: "¿Desea Generar Reporte de Informes para Comite de Pagos?",
                  text: "Generar Proceso",
                  type: "info",
                  showCancelButton: true,
                  confirmButtonText: "Confirmar",
                  ...
                  .then(function (result) {
                    if (result) {
                      ...
                      $http({
                        ...
                        url: "php/financiera/reportes/funcreportes.php",
                        data: {
                          function: "ReportedeInformesparaComitedePagos",
                          datos: datosRC,
                        },
                      }).then(function (response) {
                        if (response.data) {
          ...
          case "82":  // Archivo Tipo FT001
            if ($scope.anno == "") {
              ...
              if ($scope.anno == "" || $scope.anno == undefined || $scope.periodo == "" || $scope.periodo == undefined) {
                ...
                swal({
                  title: "¿Desea Generar Proceso Archivo Tipo FT001?",
                  text: "Generar Proceso",
                  type: "info",
                  showCancelButton: true,
                  confirmButtonText: "Confirmar",
          ...
          case "83":  // Archivo Tipo FT003
            if ($scope.anno == "") {
              ...
              if ($scope.anno == "" || $scope.anno == undefined || $scope.periodo == "" || $scope.periodo == undefined) {
                ...
                swal({
                  title: "¿Desea Generar Proceso Archivo Tipo FT003?",
                  text: "Generar Proceso",
                  type: "info",
                  showCancelButton: true,
                  confirmButtonText: "Confirmar",
          ...
          case "85":  // Archivo Tipo FT005
            if ($scope.anno == "") {
              ...
              if ($scope.anno == "" || $scope.anno == undefined || $scope.periodo == "" || $scope.periodo == undefined) {
                ...
                swal({
                  title: "¿Desea Generar Proceso Archivo Tipo FT005?",
                  text: "Generar Proceso",
                  type: "info",
                  showCancelButton: true,
                  confirmButtonText: "Confirmar",
          ...
          case "86":  // Archivo Tipo FT0011
            if ($scope.anno == "") {
              ...
              if ($scope.anno == "" || $scope.anno == undefined || $scope.periodo == "" || $scope.periodo == undefined) {
                ...
                swal({
                  title: "¿Desea Generar Proceso Archivo Tipo FT0011?",
                  text: "Generar Proceso",
                  type: "info",
                  showCancelButton: true,
                  confirmButtonText: "Confirmar",
