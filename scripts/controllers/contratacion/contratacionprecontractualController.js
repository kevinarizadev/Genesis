...
if (response.data.Codigo == 1) {
            ...
            $scope.Genera_Minuta = function (v_pnumero, v_pubicacion, v_pdocumento, fecha_inicio) {
                ...
                if (v_fecha_inicio >= fechaNuevaMinuta) {
                  $window.open('views/contratacion/formatos/formatominutacontrato_nuevoformato.php?v_pnumero=' + v_pnumero + '&v_pubicacion=' + v_pubicacion + '&v_pdocumento=' + v_pdocumento);
                }else{
                  //$window.open('views/contratacion/formatos/formatominutacontrato_nuevoformato.php?v_pnumero=' + v_pnumero + '&v_pubicacion=' + v_pubicacion + '&v_pdocumento=' + v_pdocumento);
                   $window.open('views/contratacion/formatos/formatominutacontrato.php?v_pnumero=' + v_pnumero + '&v_pubicacion=' + v_pubicacion + '&v_pdocumento=' + v_pdocumento);
                }
