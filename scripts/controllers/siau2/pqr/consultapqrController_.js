    ...
    $scope.quitarMarcacion = function (pqr) {
      swal({
        ...
        if (result.length > 0) {
          ...
          var opcionMarcacion = (permisosMarcacion.findIndex(e => e.cedula == $scope.documentologueo)) == -1 ? false : true;
          ...
          if (opcionMarcacion) {
            ...
            swal('¡Mensaje!', 'Usted no tiene permisos para realizar marcación', 'info').catch(swal.noop);
