        ...
        function ($scope, $http, $filter) {
            ...
            $scope.Consulta_EPS_IPS = function () {
                ...
                $http({
                    ...
                    data: {
                        ...
                        Num: $scope.Tabs == 'GLOSA' ? $scope.Vista2.Numero : $scope.Vista3.Numero,
                        Ubi: $scope.Tabs == 'GLOSA' ? $scope.Vista2.Ubicacion : $scope.Vista3.Ubicacion,
            ...
            $scope.ValFecha = function (SCOPE) {
                ...
                if (days > 120) {
                    ...
                    Materialize.toast('¡El rango de fechas no puede ser mayor a 120 dias!', 5000); $('.toast').addClass('default-background-dark');
                }
                console.log(days);
            }
