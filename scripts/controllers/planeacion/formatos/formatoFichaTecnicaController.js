...
angular.module('GenesisApp', [])
  ...
  .controller('formatoFichaTecnicaController', ['$scope', '$http', '$timeout', '$location', '$sce', '$q',
    function ($scope, $http, $timeout, $location, $sce, $q) {
      ...
      $scope.getData = function () {
        $http({
          ...
          data: {
            ...
            cod_pro: $location.search().cod_pro.toString(),
            cod_estr: $location.search().cod_estr.toString(),
            cod_tac: $location.search().cod_tac.toString(),
            cod_ind: $location.search().cod_ind.toString(),
            anno: $location.search().anno.toString(),
          }
        }).then(function ({ data }) {
      ...
      $scope.generarGrafica = function (x, data) {
        ...
        setTimeout(() => {
          ...
          if (x.REGC_TIPO.split('-')[0] == 'A') { // Orden Ascendente
