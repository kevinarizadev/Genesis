        ...
        $scope.cedulaLogin = sessionStorage.getItem('cedula');           
            ...
            $scope.validador_De_fecha = function () {
              ...
              if (sessionStorage.getItem('cedula') == '1045740349' || sessionStorage.getItem('cedula') == '22667472' || 
                sessionStorage.getItem('cedula') == '1062426915'
          ...
          $scope.confirmar_aportante = function () {
            ...
            $.getJSON("php/obtenersession.php").done(function (respuesta) {
                ...
                if(($scope.sesdata.cedula==1001962970)|| ($scope.sesdata.cedula==63325247) ||
                    ($scope.sesdata.cedula==1045747968)||($scope.sesdata.cedula==1143132399)||($scope.sesdata.cedula == 22655600) ||($scope.sesdata.cedula == 1046872440) || ($scope.sesdata.cedula == 55300012)  || ($scope.sesdata.cedula == 1045723407) || ($scope.sesdata.cedula == 32886271) || ($scope.sesdata.cedula == 1001914688) || ($scope.sesdata.cedula==73548240)||($scope.sesdata.cedula == 37899633)||($scope.sesdata.cedula==1143163517) || ($scope.sesdata.cedula==1140889298) || ($scope.sesdata.cedula==1067934782)||  ($scope.sesdata.cedula==1065616520)){
                    $scope.editar_novedad='S';
                }else{
                    $scope.editar_novedad='N';
                }
                if ($scope.sesdata.cedula == 1045747968 ||$scope.sesdata.cedula==63325247|| $scope.sesdata.cedula == 1001914688 ||$scope.sesdata.cedula == 1143132399 || $scope.sesdata.cedula == 1044392371 || $scope.sesdata.cedula == 22655600  ||($scope.sesdata.cedula == 1046872440) || ($scope.sesdata.cedula == 55300012)  || ($scope.sesdata.cedula == 1045723407) || ($scope.sesdata.cedula == 32886271) || ($scope.sesdata.cedula == 1001914688) || ($scope.sesdata.cedula==73548240)|| $scope.sesdata.cedula == 37899633 || $scope.sesdata.cedula == 1044393935 ||  $scope.sesdata.cedula==1065616520) {
            ...
            $scope.BuscarEmpresa = function () {
                ...
                $http({
                    ...
                    if (response.data.info_empresa.resultados == 0) {
                        swal('Información', 'No se encontraron datos del la Empresa', 'info');
            ...
            $scope.llenarform = function (objeto) {
                ...
                if (objeto.codigo_estado_registro == 'A' && (($scope.sesdata.cedula  ==1143450658) || 
                    ($scope.sesdata.cedula  ==22655600) || ($scope.sesdata.cedula==37899633) || ($scope.sesdata.cedula==1045747968) ||  ($scope.sesdata.cedula == 1001914688)||
                    ($scope.sesdata.cedula==1065616520) || ($scope.sesdata.cedula==22599293)|| 
                    ($scope.sesdata.cedula==1143132399))) {
               // if ( objeto.codigo_estado_registro == 'A' && ($scope.sesdata.cedula  ==22655600) || ($scope.sesdata.cedula==1143450658) || ($scope.sesdata.cedula==1045747968) || ($scope.sesdata.cedula==37899633) ) {
                ...
                if($scope.infoempresa.codigo_estado_registro=='A' && ($scope.sesdata.cedula==1065616520 || $scope.sesdata.cedula==37899633 || $scope.sesdata.cedula==22655600 || $scope.sesdata.cedula == 1001914688 || $scope.sesdata.cedula==1045747968 || $scope.sesdata.cedula ==  1001914688 || $scope.sesdata.cedula==1143163517 || $scope.sesdata.cedula==1143132399 )){
